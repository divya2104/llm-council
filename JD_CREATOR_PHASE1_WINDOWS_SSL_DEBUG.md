...
1. Run the stdlib SSL diagnostic script (recreate if needed — it's not committed to the repo, was handed over inline in chat) on the Windows laptop and get its output.
